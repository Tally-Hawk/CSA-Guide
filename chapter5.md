...
### سؤالات بخش (Questions)

برای تکمیل این بخش و کسب امتیاز، سؤالات زیر را پاسخ دهید:

**هدف (Target):**
- روی لینک کلیک کنید تا سیستم هدف راه‌اندازی شود.
- IP سیستم هدف با کاربر **the-student** و رمز عبور **academy_MyFon**

**سؤال:**
- دایرکتوری **غیراستاندارد** (non-standard) در درایو C: را پیدا کنید.
- محتوای فایل **flag** که در این دایرکتوری ذخیره شده است را ارسال کنید.

**Flag مثال (در سند اصلی):**
```
c8e8e9f7f3a0c6c5ed7c81e4d13d7b
```

**نکته:** دایرکتوری‌های استاندارد ویندوز همان‌هایی هستند که در جدول بالا ذکر شده‌اند (مانند Windows، Program Files، Users و غیره). هر پوشه دیگری در سطح ریشه درایو C: احتمالاً غیراستاندارد و محل قرارگیری flag است. از دستورات `dir C:\ /a` (برای نمایش پوشه‌های مخفی) یا `tree C:\` استفاده کنید تا آن را پیدا کنید.

...
برای تکمیل این بخش و کسب امتیاز، به سؤالات زیر پاسخ دهید:

**سؤال:** کدام کاربر سیستمی کنترل کامل روی پوشه **c:\Users** دارد؟

(پاسخ بر اساس محتوای سند: **BUILTIN\Administrators** دارای **(OI)(CI)(F)** است، یعنی کنترل کامل با ارث‌بری به زیرپوشه‌ها.)
